...
% Penelitian ini bertujuan untuk membuat sistem untuk mendeteksi objek luka pada citra luka
% dengan menggunakan metode \emph{GrabCut} serta membandingkan tingkat akurasinya 
% dari hasil segmentasi luka dengan menggunakan \emph{Active Contour} yang telah 
% dilakukan oleh \cite{Rizki:2022}.
