...
% sangat berkurang untuk kualitas hasil tertentu (gambar \ref{gambar:2.5}(f)). Hal ini memungkinkan 
...
Manfaat praktis dari minimisasi iteratif. Gambar. \ref{gambar:2.5}(e) dan \ref{gambar:2.5}(f) 
