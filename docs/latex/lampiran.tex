...
% \begin{figure}[H]
% 	\centering
% 	\includegraphics[width=1\textwidth]{gambar/banding_integer_hitam.png}
% 	\caption{Perbandingan akurasi antara hasil deteksi keliling luka menggunakan \emph{Grabcut} dengan \emph{Snake} versi integer  untuk kategori luka hitam}
% 	\label{img:banding_integer_hitam}
% \end{figure}

% \begin{figure}[H]
% 	\centering
% 	\includegraphics[width=1\textwidth]{gambar/banding_integer_kuning.png}
% 	\caption{Perbandingan akurasi antara hasil deteksi keliling luka menggunakan \emph{Grabcut} dengan \emph{Snake} versi integer  untuk kategori luka kuning}
% 	\label{img:banding_integer_kuning}
% \end{figure}

% \begin{figure}[H]
% 	\centering
% 	\includegraphics[width=1\textwidth]{gambar/banding_integer_merah.png}
% 	\caption{Perbandingan akurasi antara hasil deteksi keliling luka menggunakan \emph{Grabcut} dengan \emph{Snake} versi integer  untuk kategori luka merah}
% 	\label{img:banding_integer_merah}
% \end{figure}

% \begin{figure}[H]
% 	\centering
% 	\includegraphics[width=1\textwidth]{gambar/banding_interpolasi_hitam.png}
% 	\caption{Perbandingan akurasi antara hasil deteksi keliling luka menggunakan \emph{Grabcut} dengan \emph{Snake} versi interpolasi  untuk kategori luka hitam}
% 	\label{img:banding_interpolasi_hitam}
% \end{figure}

% \begin{figure}[H]
% 	\centering
% 	\includegraphics[width=1\textwidth]{gambar/banding_interpolasi_kuning.png}
% 	\caption{Perbandingan akurasi antara hasil deteksi keliling luka menggunakan \emph{Grabcut} dengan \emph{Snake} versi interpolasi  untuk kategori luka kuning}
% 	\label{img:banding_interpolasi_kuning}
% \end{figure}

% \begin{figure}[H]
% 	\centering
% 	\includegraphics[width=1\textwidth]{gambar/banding_interpolasi_merah.png}
% 	\caption{Perbandingan akurasi antara hasil deteksi keliling luka menggunakan \emph{Grabcut} dengan \emph{Snake} versi interpolasi  untuk kategori luka merah}
% 	\label{img:banding_interpolasi_merah}
% \end{figure}